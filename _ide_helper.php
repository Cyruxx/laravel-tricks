...
namespace {
	...
	class Github extends \Tricks\Facades\Github{
		/**
		 ...
		 * @static 
		 */
		 public static function __construct($provider, $config, $users, $profiles){
			//Method inherited from \Tricks\Services\Social\Github
			 \Tricks\Services\Social\Github::__construct($provider, $config, $users, $profiles);
		 }
		 ...
		 */
		 public static function register($code){
			//Method inherited from \Tricks\Services\Social\Github
			return \Tricks\Services\Social\Github::register($code);
		 }

	}
	class GithubProvider extends \Tricks\Facades\GithubProvider{
		/**
		 * 
		 *
		 * @static 
		 */
		 public static function urlAuthorize(){
			//Method inherited from \League\OAuth2\Client\Provider\Github
			 \League\OAuth2\Client\Provider\Github::urlAuthorize();
		 }
		 ...
		 * @static 
		 */
		 public static function urlAccessToken(){
			//Method inherited from \League\OAuth2\Client\Provider\Github
			 \League\OAuth2\Client\Provider\Github::urlAccessToken();
		 }
		 ...
		 * @static 
		 */
		 public static function urlUserDetails($token){
			//Method inherited from \League\OAuth2\Client\Provider\Github
			 \League\OAuth2\Client\Provider\Github::urlUserDetails($token);
		 }
		 ...
		 * @static 
		 */
		 public static function userDetails($response, $token){
			//Method inherited from \League\OAuth2\Client\Provider\Github
			 \League\OAuth2\Client\Provider\Github::userDetails($response, $token);
		 }
		 ...
		 * @static 
		 */
		 public static function userUid($response, $token){
			//Method inherited from \League\OAuth2\Client\Provider\Github
			 \League\OAuth2\Client\Provider\Github::userUid($response, $token);
		 }
		 ...
		 * @static 
		 */
		 public static function userEmail($response, $token){
			//Method inherited from \League\OAuth2\Client\Provider\Github
			 \League\OAuth2\Client\Provider\Github::userEmail($response, $token);
		 }
		 ...
		 * @static 
		 */
		 public static function userScreenName($response, $token){
			//Method inherited from \League\OAuth2\Client\Provider\Github
			 \League\OAuth2\Client\Provider\Github::userScreenName($response, $token);
		 }
		 ...
		 * @static 
		 */
		 public static function __construct($options = array()){
			//Method inherited from \League\OAuth2\Client\Provider\AbstractProvider
			 \League\OAuth2\Client\Provider\Github::__construct($options);
		 }
		 ...
		 */
		 public static function setHttpClient($client){
			//Method inherited from \League\OAuth2\Client\Provider\AbstractProvider
			 \League\OAuth2\Client\Provider\Github::setHttpClient($client);
		 }
		 ...
		 */
		 public static function getHttpClient(){
			//Method inherited from \League\OAuth2\Client\Provider\AbstractProvider
			 \League\OAuth2\Client\Provider\Github::getHttpClient();
		 }
		 ...
		 */
		 public static function getScopes(){
			//Method inherited from \League\OAuth2\Client\Provider\AbstractProvider
			 \League\OAuth2\Client\Provider\Github::getScopes();
		 }
		 ...
		 */
		 public static function setScopes($scopes){
			//Method inherited from \League\OAuth2\Client\Provider\AbstractProvider
			 \League\OAuth2\Client\Provider\Github::setScopes($scopes);
		 }
		 ...
		 * @static 
		 */
		 public static function getAuthorizationUrl($options = array()){
			//Method inherited from \League\OAuth2\Client\Provider\AbstractProvider
			 \League\OAuth2\Client\Provider\Github::getAuthorizationUrl($options);
		 }
		 ...
		 * @static 
		 */
		 public static function authorize($options = array()){
			//Method inherited from \League\OAuth2\Client\Provider\AbstractProvider
			 \League\OAuth2\Client\Provider\Github::authorize($options);
		 }
		 ...
		 * @static 
		 */
		 public static function getAccessToken($grant = 'authorization_code', $params = array()){
			//Method inherited from \League\OAuth2\Client\Provider\AbstractProvider
			 \League\OAuth2\Client\Provider\Github::getAccessToken($grant, $params);
		 }
		 ...
		 */
		 public static function getUserDetails($token){
			//Method inherited from \League\OAuth2\Client\Provider\AbstractProvider
			 \League\OAuth2\Client\Provider\Github::getUserDetails($token);
		 }
		 ...
		 */
		 public static function getUserUid($token){
			//Method inherited from \League\OAuth2\Client\Provider\AbstractProvider
			 \League\OAuth2\Client\Provider\Github::getUserUid($token);
		 }
		 ...
		 * @static 
		 */
		 public static function getUserEmail($token){
			//Method inherited from \League\OAuth2\Client\Provider\AbstractProvider
			 \League\OAuth2\Client\Provider\Github::getUserEmail($token);
		 }
		 ...
		 * @static 
		 */
		 public static function getUserScreenName($token){
			//Method inherited from \League\OAuth2\Client\Provider\AbstractProvider
			 \League\OAuth2\Client\Provider\Github::getUserScreenName($token);
		 }
	...
	class ImageUpload extends \Tricks\Facades\ImageUpload{
		/**
		 ...
		 * @static 
		 */
		 public static function __construct($filesystem){
			//Method inherited from \Tricks\Services\Upload\ImageUploadService
			 \Tricks\Services\Upload\ImageUploadService::__construct($filesystem);
		 }
		 ...
		 */
		 public static function enableCORS($origin){
			//Method inherited from \Tricks\Services\Upload\ImageUploadService
			 \Tricks\Services\Upload\ImageUploadService::enableCORS($origin);
		 }
		 ...
		 */
		 public static function handle($file){
			//Method inherited from \Tricks\Services\Upload\ImageUploadService
			return \Tricks\Services\Upload\ImageUploadService::handle($file);
		 }

	}
	class Navigation extends \Tricks\Facades\Navigation{
		/**
		 ...
		 */
		 public static function __construct($config, $auth){
			//Method inherited from \Tricks\Services\Navigation\Builder
			 \Tricks\Services\Navigation\Builder::__construct($config, $auth);
		 }
		 ...
		 */
		 public static function make($url, $type = 'menu'){
			//Method inherited from \Tricks\Services\Navigation\Builder
			return \Tricks\Services\Navigation\Builder::make($url, $type);
		 }

	}
	class Disqus extends \Tricks\Facades\Disqus{
		/**
		 ...
		 * @static 
		 */
		 public static function __construct($client, $config){
			//Method inherited from \Tricks\Services\Social\Disqus
			 \Tricks\Services\Social\Disqus::__construct($client, $config);
		 }
		 ...
		 * @static 
		 */
		 public static function appendCommentCounts($tricks){
			//Method inherited from \Tricks\Services\Social\Disqus
			return \Tricks\Services\Social\Disqus::appendCommentCounts($tricks);
		 }
